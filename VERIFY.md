...
## Test these first -- each verdict gates a class (3)
...
| Ported Reaper Chain Animations | `jio.reaper-chain-animations` | in game, look at the Reaper chain weapon animation set (every race) |
...
| Arthurian Knight Scepter (Mystic) | `recolor.for-arthurian-knight-scepter-for-mystic` | equip Discontinued Template #4065 (any race) |
...
| Santa Suit Recolor For Aman Female | `zynnobia.santa-suit-recolor-for-aman-female` | equip Human Male Santa Suit #131054 (human male) |

## Held back -- rebuild in progress (0)
...
| Bewitching Elin Genshin Impact Mona | `yupi.genshin-mona` | equip Elin Devilicious Costume #81159 (elin female) |

## Not yet installable -- being fixed (153)

Every entry here names why it cannot ship. Nothing is abandoned;
each line is a fix in the queue, worked by class.

| Mod | id | Why it is held |
|---|---|---|
...
| Sanrio Gym Uniforms | `litterboxchan.s-a-n-r-i-changes-all-the` | Duplicate-payload defect: this entry shares its exact payload with Floral Tee And Jean Shorts Outfit For, Sleepy Castanic Running Togs — it cannot del |
...
| Floral Tee & Jean Shorts | `zynnobia.floral-tee-and-jean-shorts-outfit-for` | Duplicate-payload defect: this entry shares its exact payload with S A N R I Changes All, Sleepy Castanic Running Togs — it cannot deliver its own dis |
